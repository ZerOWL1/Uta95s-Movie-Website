...
namespace Uta95s_Movie_Web___BETA_0._1.Models.Entity.Parent
{
    ...
    {
        public Movie_Actor_Director(int mId, string title, string desc, int totalEsp, string nation, string language, string release, string trailer, int length, int view, DateTime date, string download, int actorId, string actorName, string actorWiki, int did, string dName, string dNational)
        {
            mID = mId;
            this.title = title;
            this.desc = desc;
